...
$lang = array_merge($lang, array(
	...
	'MIGRATION_EXCEPTION_ERROR'			=> 'Algo correu mal durante a execução do pedido e foi criada uma excepção. As alterações feitas antes de ocorrer o erro foram revertidas da melhor forma possível. No entanto, deve verificar se existem erros no Fórum.',
	...
	'MIGRATION_REVERT_SCHEMA_IN_PROGRESS'	=> 'A reverter Esquemas: %1$s; Tempo: %2$.2f segundos',
	...
	'MODULE_EXIST_MULTIPLE'				=> 'Vários módulos com o nome do módulo pai dado já existem: %s. Tente usar as teclas antes / depois para esclarecer o posicionamento do módulo.',
	...
	'PARENT_MODULE_FIND_ERROR'			=> 'Não é possível determinar o identificador de módulo pai: %s',
