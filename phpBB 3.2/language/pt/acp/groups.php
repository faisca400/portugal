...
$lang = array_merge($lang, array(
	...
	'GROUP_MESSAGE_LIMIT_EXPLAIN'		=> 'Esta configuração substitui o limite de mensagens de cada pasta por Utilizador. O valor definido é o valor máximo de entre todos os grupos do utilizador.<br />Coloque a 0 para substituir globalmente a configuração de todos os utilizadores deste grupo.',
	...
	'GROUP_MAX_RECIPIENTS_EXPLAIN'		=> 'O número máximo de destinatários permitido numa mensagem privada. O valor definido é o valor máximo de entre todos os grupos do utilizador.<br />Coloque a 0 para substituir globalmente a configuração de todos os utilizadores deste grupo.',
	...
	'GROUP_RECEIVE_PM_EXPLAIN'			=> 'Os Grupos ocultos não podem receber mensagens, mesmo ao selecionar esta opção.',
