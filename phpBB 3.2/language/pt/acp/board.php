...
$lang = array_merge($lang, array(
	...
	'SITE_HOME_URL_EXPLAIN'			=> 'Se for especificado, será colocado no início do breadcrumbs um link para este URL e o logotipo do Fórum vai apontar para este URL em vez do índice do Fórum. É obrigatório indicar um URL, por exemplo, <samp>http://www.phpbb.com</samp>.',
...
$lang = array_merge($lang, array(
	...
	'AVATAR_GALLERY_PATH_EXPLAIN'	=> 'Caminho da pasta desde a raíz do phpBB, para Galeria de Avatares: Exemplo: <samp>images/avatares/gallery</samp>.<br />Pontos duplos como <samp>../</samp> serão retirados do caminho por razões de segurança.',
	'AVATAR_STORAGE_PATH'			=> 'Caminho da pasta onde os Avatares são guardados',
	'AVATAR_STORAGE_PATH_EXPLAIN'	=> 'Caminho da pasta desde a raíz do phpBB, para envio de Avatares. Exemplo: <samp>images/avatares/upload</samp>.<br />O Avatar <strong>não ficará disponível</strong> se a pasta não for gravável.<br />Pontos duplos como <samp>../</samp> serão retirados do caminho por razões de segurança.',
...
$lang = array_merge($lang, array(
	...
	'VISUAL_CONFIRM_REFRESH'				=> 'Permitir aos utilizadores atualizar a tarefa anti-spambot',
...
$lang = array_merge($lang, array(
	...
	'ICONS_PATH_EXPLAIN'					=> 'Caminho desde a raíz do phpBB. Exemplo: images/ícons.',
	...
	'RANKS_PATH_EXPLAIN'					=> 'Caminho desde a raíz do phpBB. Exemplo: images/ranks.',
	...
	'SMILIES_PATH_EXPLAIN'					=> 'Caminho da pasta desde a raíz do phpBB. Exemplo: images/smilies.',
	'UPLOAD_ICONS_PATH'						=> 'Caminho da pasta  de Ficheiro de Ícones de Grupos de Extensões',
	'UPLOAD_ICONS_PATH_EXPLAIN'				=> 'Caminho da pasta  desde a raíz do phpBB. Exemplo: images/upload_icons.',
...
$lang = array_merge($lang, array(
	...
	'IP_LOGIN_LIMIT_MAX_EXPLAIN'			=> 'Limite de tentativas de acesso permitido, a partir de um único endereço IP, antes da tarefa anti-spambot ser acionada. Digite 0 para impedir que a tarefa anti-spambot de ser desencadeada por endereços IP.',
...
$lang = array_merge($lang, array(
	...
	'CONTACT_EMAIL_NAME_EXPLAIN'			=> 'Este é o nome do contacto que os destinatários dos mails vão ver. Se não quer ter um nome de contacto, deixe este campo em branco.',
	...
	'SMTP_SERVER_EXPLAIN'			        => 'Observe que você tem que fornecer o protocolo que seu servidor usa. Se você estiver usando SSL, isso deve ser "ssl: //your.mailserver.com"',
