...
$lang = array_merge($lang, array(
	...
	'CHARS_POST_CONTAINS'		=> array(
		1	=> 'A sua mensagem tem %1$d carácter.',
		2	=> 'A sua mensagem tem %1$d caracteres.',
	),
	'CHARS_SIG_CONTAINS'		=> array(
		1	=> 'A sua assinatura tem %1$d carácter.',
	...
	'DELETE_POST_PERMANENTLY'			=> array(
	    1	=> 'Excluir permanentemente esta postagem para que não possa ser recuperada',
		2	=> 'Excluir permanentemente %1$d postages para que não possam ser recuperados',
	),
	...
	'DELETE_TOPIC_PERMANENTLY'			=> array(
		1	=> 'Excluir permanentemente este tópico para que ele não possa ser recuperado',
		2	=> 'Excluir permanentemente %1$d tópicos para que eles não possam ser recuperados',
	),
	...
	'DELETE_TOPICS_PERMANENTLY_CONFIRM'	=> 'Tem a certeza que deseja eliminar <strong>permanentemente</strong> estes tópicos?',
	...
	'DRAFT_LOADED'					=> 'Rascunho carregado, pode terminar a sua Mensagem. O rascunho será apagado ao enviar a Mensagem.',
	...
	'FLOOD_ERROR'					=> 'Não pode enviar uma nova Mensagem tão rapidamente. Aguarde algum tempo e tente novamente mais tarde.',
	...
	'MAX_FLASH_HEIGHT_EXCEEDED'	=> array(
		1	=> 'O seu ficheiro flash só pode ter até %d píxel de altura.',
		2	=> 'Os seus ficheiros flash só podem ter até %d píxeis de altura.',
	),
	'MAX_FLASH_WIDTH_EXCEEDED'	=> array(
		1	=> 'O seu ficheiro flash só pode ter até %d píxel de largura.',
		2	=> 'Os seus ficheiros flash só podem ter até %d píxeis de largura.',
	),
	'MAX_IMG_HEIGHT_EXCEEDED'	=> array(
		1	=> 'A sua imagem só pode ter até %1$d píxel de altura.',
		2	=> 'As suas imagens só podem ter até %1$d píxeis de altura.',
	),
	'MAX_IMG_WIDTH_EXCEEDED'	=> array(
		1	=> 'A sua imagem só pode ter até %d píxel de largura.',
		2	=> 'As suas imagens só podem ter até %d píxeis de largura.',
	),

	'MESSAGE_BODY_EXPLAIN'		=> array(
		0	=> '', // zero means no limit, so we don't view a message here.
		1	=> 'Digite aqui a sua mensagem, pode conter mais do que <strong>%d</strong> carácter.',
	...
	'POLL_FOR_EXPLAIN'				=> 'Insira 0 ou deixe o campo em branco para uma votação sem tempo limite.',
	...
	'POST_CONFIRM_EXPLAIN'			=> 'Para evitar Mensagens automáticas, o fórum exige que digite o código de confirmação. O código é mostrado na imagem abaixo. Se não consegue ver a imagem, por favor contacte o %sAdministrador%s.',
